...
typedef struct
{
  ...
  #ifdef  MEM_CERTIFICATE
     char *mem_root_cer;  //内存形式的根证书
     char *mem_client_cer;  //设备端的公共证书
     char *mem_key_cer;  //设备端的私有证书
  #endif
...
#define MQTTClient_SSLOptions_initializer { {'M', 'Q', 'T', 'S'}, 5, NULL, NULL, NULL, NULL, NULL, 1, MQTT_SSL_VERSION_DEFAULT, 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL }
...
#define MQTTClient_SSL_CHANGAN                                                                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    {'M', 'Q', 'T', 'S'}, 5, "/system/bin/cert/cqca.cer", "/system/bin/cert/01CAG2017022200003655.cer", "/system/bin/cert/01CAG2017022200003655.key", NULL, NULL, 1, MQTT_SSL_VERSION_DEFAULT, 1, "/system/bin/cert", NULL, NULL, NULL, NULL, 0, NULL, 0  }
