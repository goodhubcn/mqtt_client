...
typedef void MQTTAsync_connect_prepare(void* context, int connect_fd);
...
LIBMQTT_API int MQTTAsync_setConnectPrepare(MQTTAsync handle, void* context, MQTTAsync_connect_prepare* prepare);
...
#define MQTTAsync_SSLOptions_initializer { {'M', 'Q', 'T', 'S'}, 5, NULL, NULL, NULL, NULL, NULL, 1, MQTT_SSL_VERSION_DEFAULT, 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL }
